...
$container_class = 'fat-semantic-container fat-booking-container fat-sb-services-layout fat-sb-layout-' . $column . '-column';
...
<div class="<?php echo esc_attr($container_class); ?>" style="opacity: 0;"
    ...
    <div class="fat-sb-tab-wrap">
        <ul class="fat-sb-tab">
            <li class="active" data-tab="services" data-onClick="FatSbBookingServices_FE.tabItemOnClick">
                <?php echo sprintf(esc_html__('Select %s', 'fat-services-booking'), strtolower($service_label)); ?>
            </li>
            <li class="fat-disabled employee" data-tab="services-provider" data-onClick="FatSbBookingServices_FE.tabItemOnClick">
                <?php echo sprintf(esc_html__('Select %s', 'fat-services-booking'), strtolower($employee_label)); ?>
            </li>
    ...
    <div class="fat-sb-tab-content-wrap">
        <div class="fat-sb-tab-content has-box-shadow services active" data-tab="services">
        ...
        <div class="fat-sb-tab-content has-box-shadow service-provider fat-hidden" data-tab="services-provider">
            ...
            <div class="fat-sb-customer-wrap">
                ...
                <div class="fat-sb-col-right">
                    ...
                    <ul class="fat-order-wrap">
                        ...
                        <li class="fat-sb-remain-slot">
                            <span class="fat-item-label"><?php echo esc_html__('Remain slot:', 'fat-services-booking'); ?></span>
                            <span class="fat-item-value" data-value="0"></span>
                        </li>
                        <?php
...
<script type="text/html" id="tmpl-fat-sb-service-item-template">
    ...
    <div class="fat-sb-service-item cat-{{item.s_category_id}}">
        <div class="fat-sb-service-item-inner" data-id="{{item.s_id}}"
             data-multiple-days="{{item.s_multiple_days}}"
            ...
            <div class="fat-sb-item-content">
                ...
                <div class="service-desc">{{item.s_description}}</div>
                <div class="meta">
                    <div class="duration">
