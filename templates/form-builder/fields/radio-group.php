...
<div class="one fields">
    <div class="field">
        ...
        <?php endif; ?>
        <div class="fat-sb-radio-group fat-sb-field-builder <?php echo (isset($field->inline) && $field->inline ? 'inline' : '');?>"
            ...
            <?php if (isset($field->values) && is_array($field->values)):
                ...
                foreach ($field->values as $v) {
                    ?>
                    <div class="fat-sb-radio-item">
                        <input type="radio" name="<?php echo(isset($field->name) ? $field->name : ''); ?>" id="<?php echo esc_attr($field->name.'_'.$index);?>"
