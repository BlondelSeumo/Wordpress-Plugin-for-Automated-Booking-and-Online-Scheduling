...
$category = isset($atts['category']) && $atts['category'] ? $atts['category'] : 0;
...
$container_class = 'fat-semantic-container fat-booking-container fat-sb-services-layout services-no-tab fat-sb-layout-' .$column.'-column';
...
<div class="<?php echo esc_attr($container_class);?>" style="opacity: 0"
   ...
   <div class="fat-sb-tab-content-wrap">
    <div class="fat-sb-tab-content has-box-shadow services active" data-tab="services" data-next-tab="services-provider">
    ...
    <div class="fat-sb-tab-content has-box-shadow service-provider fat-sb-hidden" data-tab="services-provider" data-next-tab="time" >
    ...
    <div class="fat-sb-tab-content time fat-sb-hidden" data-tab="time" data-next-tab="customer">
        ...
        <div class="fat-sb-datetime-wrap">
            <div class="fat-sb-datetime-inner">
                <div class="fat-sb-booking-date-wrap">
                    <input type='text' class="air-date-picker fat-sb-hidden"  data-locale="<?php echo esc_attr($locale); ?>" required autocomplete="off"
                    name="b_date" id="b_date" />
                </div>
                <div class="fat-sb-booking-time-wrap">
                    <h4 class="fat-sb-time-title"><?php echo esc_html__('Times','fat-services-booking');?></h4>
                    <?php
                    ...
                    <?php foreach ($work_hours as $key => $value) { ?>
                        <div class="item disabled" data-value="<?php echo esc_attr($key); ?>" data-label="<?php echo esc_attr($value);?>"
        ...
        <div class="fat-sb-multiple-days">
            <h4><?php echo esc_html('Selected dates', 'apoint'); ?></h4>
...
<div class="fat-sb-tab-content customer fat-sb-hidden" data-tab="customer" data-next-tab="completed">
    <div class="fat-sb-data-selected">
    ...
    <div class="fat-sb-customer-wrap">
            ...
            <div class="ui form">
                <div class="two fields">
                        ...
                        <div class="two fields <?php echo ($disable_customer_email? 'fat-sb-hidden' : '');?>">
                                ...
                                <div class="one fields number-of-person-field">
                                    <div class="field">
                                        <label><?php echo esc_html($number_of_person_label); ?> <span
                                            class="required"> *</span></label>
                                            <select class="fat-sb-number-of-person-wrap" name="number_of_person" id="number_of_person" data-onChange="FatSbBookingServices_FE.numberPersonOnChange">
                            ...
                            <div class="fat-sb-col-right">
                                ...
                                <ul class="fat-order-wrap">
                                    ...
                                    if($is_exist_coupon): ?>
                                        <li class="fat-sb-order-coupon">
                                            ...
                                            <span class="fat-item-value">
                                                <div class="ui left input">
                                                    <input type="text" name="coupon" id="coupon" data-onChange="FatSbBookingServices_FE.couponOnChange"
                                ...
                                <li class="fat-sb-order-payment-method">
                                    ...
                                    <select class="fat-sb-payment-method-wrap" name="payment_method" id="payment_method" data-onChange="FatSbBookingServices_FE.paymentOnChange">
                                ...
                                <?php if(isset($setting['stripe_enable'])  &&  $setting['stripe_enable']) : ?>
                                    <li class="fat-sb-order-stripe">
                                        ...
                                        <div class="form-row">
                                            <div class="card-element"  id="card-element-<?php echo uniqid(); ?>">
                    ...
                    <div class="fat-sb-button-group">
                        ...
                        <button class="ui primary button fat-next-step fat-bt-payment" data-onClick="FatSbBookingServices_FE.submitBooking"
                        data-next-step="completed">
                        <span><?php esc_html_e('Next', 'fat-services-booking'); ?></span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="fat-sb-tab-content completed fat-sb-hidden" data-tab="completed" >
            ...
            <div class="fat-mg-top-15">
                <button class="ui primary button fat-bt-add-google-calendar" data-onClick="FatSbBookingServices_FE.addToGoogleCalendar">
                    <span><?php esc_html_e('Add to Google calendar', 'fat-services-booking'); ?></span>
                </button>
                <button class="ui primary button fat-bt-add-icalendar" data-onClick="FatSbBookingServices_FE.addToICalendar">
                    <span><?php esc_html_e('Add to iCalendar', 'fat-services-booking'); ?></span>
                </button>
            </div>
        </div>
    </div>
...
<script type="text/html" id="tmpl-fat-sb-service-cat-item-template">
    ...
    <div class="fat-sb-service-item">
        ...
        data-onClick="FatSbBookingServices_FE.serviceCatItemOnClick">
        <div class="fat-sb-item-avatar">
...
<script type="text/html" id="tmpl-fat-sb-service-item-template">
    ...
    <div class="fat-sb-service-item cat-{{item.s_category_id}}">
        <div class="fat-sb-service-item-inner" data-id="{{item.s_id}}"
        data-duration="{{item.s_duration}}"
...
<script type="text/html" id="tmpl-fat-sb-location-item-template">
    ...
    <div class="fat-sb-list-item">
        <div class="fat-sb-list-item-inner" data-loc="loc_{{item.loc_id}}" data-id="{{item.loc_id}}" data-onClick="FatSbBookingServices_FE.locationItemOnClick">
